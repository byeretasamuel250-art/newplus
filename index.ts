...
// `notifications`. Looks up the recipient's push subscriptions and
// sends a Web Push notification via VAPID, including an unread-count
// badge so installed PWAs (Android/Chrome) show a number on the icon.
//
